...
# Hidden sizes
rnn_default_vals = {"emb_size":300, "num_layers":1, "num_classes":3, "weight":torch.FloatTensor(weights), "attention":True, "max_length":50}
...
rnn_default_vals = {"emb_size":300, "num_layers":1, "hidden_size": 250, "num_classes":3, "weight":torch.FloatTensor(weights)}
